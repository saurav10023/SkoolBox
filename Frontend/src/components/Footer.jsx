      ...
      <div className="bg-white/[0.03] border-b border-white/5">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 py-5 sm:py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3 text-center sm:text-left">
            <div className="w-10 h-10 sm:w-11 sm:h-11 bg-green-500 rounded-xl flex items-center justify-center shrink-0 shadow-lg shadow-green-950/40">
            ...
            <div>
              <p className="text-white font-semibold text-sm sm:text-base">Chat with us on WhatsApp</p>
              <p className="text-gray-500 text-xs sm:text-sm">Quick replies · Uniforms, sizes, orders & more</p>
            </div>
          </div>
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex items-center gap-2 bg-green-500 hover:bg-green-400 active:scale-95 text-white font-semibold text-sm px-5 py-2.5 rounded-xl shadow-lg shadow-green-950/30 transition-all duration-200 whitespace-nowrap w-full sm:w-auto justify-center"
          >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-12 lg:py-16 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-10 lg:gap-12">
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 sm:w-14 sm:h-14 bg-blue-600 rounded-xl flex items-center justify-center shadow-lg shadow-blue-950/40 overflow-hidden shrink-0">
              <img
                src={logo}
                alt="Skool Box logo"
            ...
            <div className="leading-tight">
              ...
              <span className="block font-medium text-blue-400 text-[10px] sm:text-xs tracking-[0.2em] uppercase">Store</span>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 pt-1">
            <a href="#" aria-label="Instagram"
              className="w-9 h-9 sm:w-8 sm:h-8 bg-white/5 hover:bg-blue-600 border border-white/10 hover:border-blue-600 text-gray-400 hover:text-white rounded-lg flex items-center justify-center transition-all duration-200">
              <Instagram size={14} />
            </a>
        ...
        <div className="space-y-4 sm:col-span-2 lg:col-span-1">
            ...
            {storeHours.map(({ day, open }) => {
              ...
              return (
                <div key={day} className="flex flex-col items-center gap-1">
                  <span className={`text-[10px] font-semibold ${isToday ? "text-blue-400" : "text-gray-600"}`}>
                    {day}
                  </span>
                  <div className={`w-7 h-7 sm:w-8 sm:h-8 rounded-lg flex items-center justify-center text-[10px] font-bold border transition-all
                    ${isToday
                      ? open
                        ? "bg-blue-600 border-blue-600 text-white shadow-md shadow-blue-950/50"
          ...
          {/* Time range */}
          <div className="bg-white/[0.03] border border-white/10 rounded-xl px-4 py-3 space-y-2">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="flex items-center gap-2 w-full justify-center bg-green-950/40 hover:bg-green-900/40 border border-green-800/50 hover:border-green-700 text-green-400 hover:text-green-300 text-xs font-semibold py-2.5 rounded-xl transition-all duration-200"
          >
